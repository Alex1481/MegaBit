...
<title>| MEGA BIT | Bienvenid@ |</title>
...
<body>
    ...
    ================================================== -->
		...
		<div class="row page-header">
			<div class="col-lg-12">
				<h1 align="center" class="text text-center">
					<span class="label label-success">LISTADO DE PELICULAS</span>
				</h1>
				<h2 align="center" class="text text-center">
					<span class="label label-success">DISPONIBLES EN MEGA BIT</span>
				</h2>
		...
		<div class="container marketing">
			...
			<div class="page-header">
				<h2 class="text text-center">
					<span class="label label-success">NOVEDADES - PROMOCIONES</span>
				</h2>
			</div>
