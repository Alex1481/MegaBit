	            ...
	            <tr>
                   ...
                   <c:choose>
	                ...
	                <td>
	                    ...
	                    <a href="${urlBanners}/delete/${banner.id}" onclick='return confirm("¿Estas seguro que desea eliminar el Banner?")' class="btn btn-danger btn-sm" role="button" title="Eliminar" ><span class="glyphicon glyphicon-trash"></span></a>
	                </td>
            	</tr>
            </c:forEach>
